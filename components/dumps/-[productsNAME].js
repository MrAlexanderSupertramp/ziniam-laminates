...
// export default function Product_detail({ statusCode, data }) {
...
//                                             <p>
//                                                 Phasellus luctus commodo ullamcorper a posuere rhoncus commodo elit aenean congue, risus utaliquam dapibus lorem ipsum dolor. ommodo elit aenean congue, risus utaliquam dapibus lorem ipsum dolor. Thanks!
//                                             </p>
//                                         </blockquote>
//                                     </div>
...
//                                     {/* <!-- Logo Item --> */}
//                                     <div className="logo-item">
//                                         <img src="/images/clients-logos/client-3.png" width="150" height="90" alt="Company Name" />
//                                     </div>
                                    
//                                     {/* <!-- Logo Item --> */}
//                                     <div className="logo-item">
//                                         <img src="/images/clients-logos/client-4.png" width="150" height="90" alt="Company Name" />
//                                     </div>
...
//                                         </svg>
//                                     </div>
//                                     <h3 className="alt-features-title">Unique Design</h3>
//                                     <div className="alt-features-descr">
//                                         Fusce aliquet quam eget neque ultrices elementum felis id arcu blandit sagittis. Maecenas volutpat, diam enim.
//                                     </div>
//                                 </div>
//                             </div>
...
//                                         </svg>
//                                     </div>
//                                     <h3 className="alt-features-title">Quality Code</h3>
//                                     <div className="alt-features-descr">
//                                         Suspendisse ultricies eros blandit. Lorem ipsum dolor sit lorem amet rembe adipis elite Inwege maximus ligula. 
//                                     </div>
//                                 </div>
//                             </div>
...
//                                         </svg>
//                                     </div>
//                                     <h3 className="alt-features-title">Clean and Minimal</h3>
//                                     <div className="alt-features-descr">
//                                         Duis placerat ex gravida nibh tristique porta. Maecenas volutpat, enime volutpa cractus interdum sodales.
//                                     </div>
//                                 </div>
//                             </div>
...
//                                         </svg>
//                                     </div>
//                                     <h3 className="alt-features-title">Easy Customization</h3>
//                                     <div className="alt-features-descr">
//                                         Praesent sed nisi eleifend lorem ember fermete acome ante lorem ipsum. Duis gravida nibh tristique porta.
//                                     </div>
//                                 </div>
//                             </div>
...
//                                 <h3 className="call-action-1-heading">Want to discuss your new project?</h3>
...
//                                     <a href="pages-contact-1.html" className="btn btn-mod btn-w btn-large btn-round">Let's Talk</a>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
...
//             .get(`http://localhost:8000/api/product/` + product_single)
//             .then((response) => {
//                 response = {
